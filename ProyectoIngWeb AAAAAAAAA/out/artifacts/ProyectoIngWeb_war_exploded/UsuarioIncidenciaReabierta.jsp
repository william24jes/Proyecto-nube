                            ...
                            <div class="col-lg-12 mx-auto">
                                ...
                                <div class="card shadow mb-4 ">
                                    ...
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        ...
                                        <br>
                                        <div></div>
                                        <h4 class="m-0 font-weight-bold text-primary" style="width:75%">Pérdida de
                                            carnet
                                            universitario #ayuda
                                            #cachimbo #2022-2
                                    ...
                                    <div class="card-body">
                                        <p style="color:darkgray">Abierto una vez, le quedan 4 intentos</p>
                                        ...
                                        corporis
                                        doloribus error ex facere itaque iusto neque nobis non optio quaerat quam quas,
                                        quisquam
                                        ...
                                        <div><br><h5>Comentario de Seguridad: </h5>Lorem ipsum dolor sit amet,
                                            consectetur
                                            adipisicing elit. Ab accusantium alias amet
                                            dolore doloremque ea, et exercitationem impedit itaque iure maxime neque
                                            nobis odit
                                            ...
                                            reprehenderit
                                            saepe! Accusantium consectetur, delectus deserunt eum hic nihil provident
                                            quos sunt
                                            tempore tenetur veniam?
                                        </div>

                                        <div style="text-align: right"><br><h5>Comentario de Frank Einstein: </h5>Lorem
                                            ipsum dolor
                                        ...
                                        <div><br><h5>Comentario de Seguridad: </h5>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1"><br><h5>Comentario de Frank
                                                    Einstein: </h5></label>
