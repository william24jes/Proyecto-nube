                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="pt-4 pb-2">
                                            ...
                                            <p class="text-left small">Ingresa el correo de tu cuenta para que puedas
                                        ...
                                        <form method="post" action="<%=request.getContextPath()%>/IniciarSesion?post=olvidoContraseña" class="row g-3 needs-validation" novalidate>
                                            ...
                                            <div class="col-6">
                                                    <button type="submit" class="btn btn-primary w-100">Recibir correo
                                                    </button>
                                            </div>

                                            <div class="col-6">
                                                <a class="nav-link" href="<%=request.getContextPath()%>/IniciarSesion">
                                                    <button class="btn btn-secondary w-100" type="button">Cancelar
                                                    </button>
                                                </a>
                                            </div>
                                        </form>
