                  ...
                  <div class="card-body">
                    ...
                    <form method="post"
                      ...
                      <div class="col-12">
                        ...
                        <input disabled type="password" name="nuevaPassword1" class="form-control"
                      ...
                      <div class="col-12">
                        ...
                        <input disabled type="password" name="nuevaPassword2" class="form-control"
                               id="yourPassword2" required>
                        <div class="invalid-feedback">Confirma tu contraseña</div>
                      </div>
                      <br>
                      <p class="text-primary small mb-0">Su contraseña se ha reesteblecido con éxito
                      </p>
                      <div class="col-12">
