                            ...
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="pt-4 pb-2">
                                            <h5 class="card-title text-center pb-0 fs-4">¡Pin inválido!</h5>
                                            <p class="text-center small">El PIN que ha ingresado es invpalido o se encuentra caducado.</p>
                                        </div>

                                        <div class="col-12">
                                            <a class="nav-link" href="<%=request.getContextPath()%>/IniciarSesion">
                                                <button type="button" class="btn btn-primary w-100">Volver a iniciar sesión
                                                </button>
                                            </a>
                                        </div>
