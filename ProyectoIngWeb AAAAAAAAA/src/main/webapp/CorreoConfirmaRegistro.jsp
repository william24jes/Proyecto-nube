                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="pt-4 pb-2">
                                            ...
                                            <p class="text-center small">Se envió un correo de confirmación de registro al correo que indicaste, por favor verifica tu bandeja de entrada para poder completar tu registro.</p>
                                        </div>
