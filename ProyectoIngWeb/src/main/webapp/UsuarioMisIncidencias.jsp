              ...
              <div class="col-lg-10 mx-auto">
                ...
                <div class="card shadow mb-4 ">
                  ...
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <br>
                    <div></div>
                    <h4 class="m-0 font-weight-bold text-primary" style="width:75%">Accidente comedor de
                      letras #comedor #trabajadores
                      <div style="color:darkgray;display: flex;flex-direction: column"><h6>Frank
              ...
              <div class="col-lg-10 mx-auto">
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <br>
                    <div></div>
                    <h4 class="m-0 font-weight-bold text-primary" style="width:75%">Objeto perdido
                      encontrado en ee.gg.cc
                      <div style="color:darkgray;display: flex;flex-direction: column"><h6>Frank
                        Einstein </h6><h6>Registrado hace 1 día</h6></div>
                    </h4>
                    <h6 style="color:red">Urgente</h6>
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <h4 class="m-0 font-weight-bold text-primary" style="width:75%">Pérdida de carnet
                      ...
                      #cachimbo #2022-2
                      <div style="color:darkgray;display: flex;flex-direction: column"><h6>Frank
                        Einstein </h6><h6>Registrado hace 2 días</h6></div>
                    </h4>
                    <h6 style="color:red">Urgente</h6>
                    <a href="#" class="btn btn-warning btn-circle">
                      <i class="fas fa-exclamation-triangle"> 10</i>
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <h4 class="m-0 font-weight-bold text-primary" style="width:75%">Pérdida de carnet
                      ...
                      #cachimbo #2022-2
                      <div style="color:darkgray;display: flex;flex-direction: column"><h6>Frank
                        Einstein </h6><h6>Registrado hace 3 día</h6></div>
                    </h4>
                    <h6 style="color:red">Urgente</h6>
                    <a href="#" class="btn btn-warning btn-circle">
                      <i class="fas fa-exclamation-triangle"> 10</i>
